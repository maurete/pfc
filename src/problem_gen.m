...
%
    ...
    if isstr(data_spec)
        ...
        elseif strcmpi(data_spec,'ng')
            data_spec = { ...
                'mirbase82-mipred/multi:hsa', 1, [200 123], ...
                'coding', -1, [400 246], ...
                        };
        elseif strcmpi(data_spec,'batuwita')
            data_spec = { ...
                ...
                'other-ncrna/multi', -1, [96 658] ... % 754*8494/9248
                        };
        elseif strcmpi(data_spec,'updated')
            data_spec = { ...
                'updated', 1, 0, ...
                        };
        elseif strcmpi(data_spec,'conserved-hairpin')
            data_spec = { ...
                'conserved-hairpin', 1, 0, ...
                        };
        elseif strcmpi(data_spec,'cross-species')
            data_spec = { ...
                'cross-species', 1, 0, ...
                        };
        elseif strcmpi(data_spec,'ie-nh')
            data_spec = { ...
                ['mirbase82-mipred/multi:aga,age,ame,ath,bta,', ...
        ...
        elseif strcmpi(data_spec,'ie-nc')
            data_spec = { ...
                'functional-ncrna/multi', -1, 0, ...
                        };
        elseif strcmpi(data_spec,'mirbase21')
            data_spec = { ...
                'mirbase21/multi:hsa', 1, 0, ...
                        };
        elseif strcmpi(data_spec,'delta-mirbase21')
            data_spec = { ...
                'mirbase20/multi:hsa', 1, 1, ...
                'coding', -1, [2990 0], ...
                'other-ncrna/multi', -1, [754 0], ...
                'mirbase21/diff', 1, 0, ...
                        };
        else
