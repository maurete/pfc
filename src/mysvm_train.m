...
%   See also MYSVM_CLASSIFY
    ...
    % fprintf('mysvm_train boxconstraint %12.6f\n', boxconstraint)
    % fprintf('mysvm_train autoscale %d, tol %12.6f\n', autoscale, tolkkt)
    ...
    bsv(sviplus)  = abs(model.alpha_(sviplus)-Cplus)<10*tolkkt;
    bsv(sviminus) = abs(model.alpha_(sviminus)+Cminus)<10*tolkkt;
