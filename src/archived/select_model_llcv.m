function [svm_params paramh errh] = select_model_llcv(dataset, featset, kernel, lib, npart, ratio, randseed, data)
    ...
    errfunc = @(model,deriv,args,input,target)...
              error_llcv_svm(trainfunc,model,deriv,args,part,input,target);
