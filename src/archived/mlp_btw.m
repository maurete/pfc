function mlp_btw ( num_iterations, train_function )
    ...
    [tr_real ts_real]     = partset(real, 560);
    [tr_pseudo ts_pseudo] = partset(pseudo,1122);
    ...
    for t=1:num_iterations
        ...
        if ir > size(tr_real,2)
            [tr_real ts_real] = partset(real,560); ir=1;
        end
    ...
    save( ['mlp_btw_' datestr(now,'yyyymmdd_HHMMSS') '.mat'],'se','sp');
