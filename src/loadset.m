...
%       70: dataset id (same as input id)
    ...
    % valid dataset names
    valid_names = {            'coding'; 'conserved-hairpin';            ...
                     'functional-ncrna'; 'functional-ncrna-multi';       ...
                            'mirbase50'; 'mirbase50-xsp'; 'mirbase82-nr'; ...
                   'mirbase82-nr-multi'; 'mirbase12'; 'mirbase12-multi'; ...
                  'mirbase12-micropred'; 'mirbase12-micropred-multi';    ...
                            'mirbase20'; 'mirbase20-nr';                 ... 
                   'mirbase20-nr-multi'; 'mirbase20-multi'; 'other-ncrna'; ...
                    'other-ncrna-multi'; 'updated' };
