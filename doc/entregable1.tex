\documentclass[12pt,bibliography=oldstyle,DIV=12,parskip=half-]{scrartcl}
...
\begin{document}
\selectlanguage{spanish}
%\DeclareMathAlphabet{\mathtt}{OT1}{zi4}{m}{n}
%\UseMathAlphabet{\mathtt}{OT1}{zi4}{m}{n}
%
% pagina de titulo
\begin{titlepage}
%
...
\begin{enumerate}
\item Clasificador mediante SVM utilizando \emph{libsvm} con los
...
\end{enumerate}
%
La librería \emph{libsvm} provee una utilidad \mono{svm-easy} que
