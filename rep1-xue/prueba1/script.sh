...
ln -fs ../fautil .
#
echo -e "1. copio datos de homo sapiens ya plegados a 2-hsa-folded.fa"
cat ../original/2_predict_secondary_structure_of_miRNAs/hsa.secondstructure > 2-hsa-folded.fa
#
