function mlp_ng ( num_iterations )
    ...
    [tr_real ts_real] = partset(real, 200);
    [tr_pseudo ts_pseudo] = partset(pseudo,400,646);
    ...
    for t=1:num_iterations
	    ...
	    [tr_real ts_real] = partset(real,200); ir=1;
        end
        if ip > size(tr_pseudo,2)
	    [tr_pseudo ts_pseudo] = partset(pseudo,400,646); ip=1;
        end
    ...
    save( ['mlp_ng_' datestr(now,'yyyymmdd_HHMMSS') '.mat'],'se','sp');
